...
var WurflCloudClient = function(config, user_request, user_response, type_of_cache){
	console.log("This is from the callWurflServer: Request only Connection: --------------- ");
	//console.log(user_request.connection);
	//console.log("This is from the callWurflServer: Response: --------------- ");
...
WurflCloudClient.prototype = {
	...
	//adding the appropriate HTTP Headers to the request
	    ...
	    console.log("Printing the IP:");
	    console.log(this.http_request.connection.remoteAddress);
	    //var fwd = null;
	    //if (typeof this.http_request.headers['x-forwarded-for'] != 'undefined') {
		//fwd = this.http_request.headers['x-forwarded-for'];
	    //}
	    //console.log("Printing the FWD IP:");
	    //console.log(this.http_request.headers['x-forwarded-for']);
	    //if (fwd != null){
	    ...
	    //}
	    console.log("Printing the Request Options");
	    console.log(this.http_request_options['X-Forwarded-For']);
